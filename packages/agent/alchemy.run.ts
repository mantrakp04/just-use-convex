...
export const worker = await Worker("agent-worker", {
  ...
  bindings: {
    ...
    SANDBOX_VOLUME_MOUNT_PATH: env.SANDBOX_VOLUME_MOUNT_PATH,
    SANDBOX_SNAPSHOT: env.SANDBOX_SNAPSHOT,
    SANDBOX_INACTIVITY_TIMEOUT_MINUTES: String(env.SANDBOX_INACTIVITY_TIMEOUT_MINUTES),
